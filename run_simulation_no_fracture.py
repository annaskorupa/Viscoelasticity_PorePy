"""Simulation without fracture: 8-hour creep test.

Produces:
1. ``_output/displacement_no_frac_8h.png`` — displacement magnitude map at 8 h
2. ``_output/strain_eyy_no_frac.png`` — ε_yy(t) vs experimental and 1D data
3. ``_output/strain_no_frac.npz`` — raw strain history

Usage::

    python run_simulation_no_fracture.py
"""

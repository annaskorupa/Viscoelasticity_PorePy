...
class BoundaryConditionsMixin:
    ...
    def bc_values_displacement(self, bg: pp.BoundaryGrid) -> np.ndarray:
        ...
        values[0, domain_sides.south] = self.units.convert_units(0.0, "m") * bg.cell_volumes[domain_sides.south]
        values[1, domain_sides.south] = self.units.convert_units(0.0, "m") * bg.cell_volumes[domain_sides.south]

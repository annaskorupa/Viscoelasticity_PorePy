...
if __name__ == "__main__":
    ...
    model_params = {
        ...
        #adding time manager and newton solver parameters to the model parameters 
        # dictionary according to tracer flow tutorial
        ...
        #"grid_type": "cartesian",  # cartesian grid - overwriting from GeometryMixin 
        "plot_schedule": [
    ...
    class ViscoelasticMomentumBalanceShowCase(ViscoelasticMomentumBalance):
        """Showcasing ViscoelasticMomentumBalance with some plots at scheduled times."""
